...
`endif
   ...
   parameter slave0_sel_width = 4;
   parameter slave0_sel_addr = 4'hx;
   
   parameter slave1_sel_width = 4;
   parameter slave1_sel_addr = 4'hx;

   parameter slave2_sel_width = 8;
   parameter slave2_sel_addr = 8'hxx;

   parameter slave3_sel_width = 8;
   parameter slave3_sel_addr = 8'hxx;

   parameter slave4_sel_width = 8;
   parameter slave4_sel_addr = 8'hxx;

   parameter slave5_sel_width = 8;
   parameter slave5_sel_addr = 8'hxx;
   
   parameter slave6_sel_width = 8;
   parameter slave6_sel_addr = 8'hxx;
   
   parameter slave7_sel_width = 8;
